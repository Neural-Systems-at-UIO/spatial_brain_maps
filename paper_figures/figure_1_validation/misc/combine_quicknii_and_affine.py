...
from paper_figures.figure_1_validation.misc.affine_utliities import (
...
registration_jsons = glob(
    "/mnt/g/Allen_Realignment_EBRAINS_dataset/registration_data/QUINT_registration_jsons/*.json"
)
